...
const SecondScreen=()=>{
    ...
    return <>
<div className={styles.title}>אם תמיד אמרת לעצמך</div>
...
<Why title="אני רוצה להיות הבוסית של עצמי" icon={nail} description="תמיד ידעת שאת רוצה לנהל את החיים של עצמך ולהחליט מה לעשות בכל רגע נתון! לא להיות תלויה בבוס ולעבוד בשעות לא שעות כדי שבסוף הוא ירוויח יותר" />
    <Why title="אני רוצה להרוויח יותר" icon={nail} description=" במקום לעשות משכורת חודשית של 15,000 (ואפילו יותר) את תקועה עם שכר מינימום וטיפים שעשו לך טובה שהביאו לך, את לא שווה את זה ומגיע לך הרבה יותר!" />
    <Why title="התחום הזה בדיוק בשבילי" icon={nail} description="תמיד אהבת להתעסק עם ציפורניים, תמיד עניין אותך לקחת את זה לשלב הבא אבל הרגשת כל פעם שזה לא הזמן לעשות את הצעד" />
    </div>
